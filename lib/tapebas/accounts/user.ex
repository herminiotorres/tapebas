defmodule Tapebas.Accounts.User do
  @moduledoc false
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Tapebas.Repo)
  ...
  """
  def valid_password?(%Tapebas.Accounts.User{hashed_password: hashed_password}, password)
